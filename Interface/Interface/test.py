...
class simframe(Frame):
	def __init__(self,master,waypointlist):
		...
		self.takeoffbutton=Button(self, text="Takeoff", command=self.takeoff)
		self.emergencylandbutton=Button(self, text="Emergency Land",fg='red', command=self.emergencyland)
